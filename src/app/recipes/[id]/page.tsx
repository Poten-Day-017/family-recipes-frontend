      ...
      <div>
        ...
        <div className="py-2 border-y border-b-main-black mt-[15px]">
          <div className="h-10 flex text-xs justify-between items-center">
            ...
            <div className="border font-medium rounded-[3px] px-2 h-7 inline-flex justify-center items-center border-main-black bg-main-green-2">
              {origin}
            </div>
            <span>카테고리</span>
            <div className="border font-medium rounded-[3px] px-2 h-7 inline-flex justify-center items-center border-main-black">
              {categoryName}
            </div>
            <span>용량</span>
            <div className="border font-medium rounded-[3px] px-2 h-7 inline-flex justify-center items-center border-main-black">
          ...
          <div className="absolute left-[-16px] w-[calc(100%+32px)] px-4 bg-main-green-2 flex flex-col items-center pt-5 rounded-t-[10px]">
            ...
            <div className="w-full border-main-black border-y mb-5">
              <div className="w-full border-beige-500">
                {procedureList.map(({ order, description, imageUrl }, idx) => {
                  return (
                    <div
                      key={order}
                      className={`${idx !== procedureList.length - 1 ? "border-b" : ""} border-beige-500 flex py-5 px-2.5`}
                    >
                      {imageUrl && (
                        <>
                          <Image
